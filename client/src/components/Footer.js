    ...
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-gray-900 text-white">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2 text-sm text-center sm:text-left">
          <p className="text-base font-bold tracking-wide text-orange-400">
            Contacts
          </p>
        ...
        <div className="text-center sm:text-left">
          ...
          <div className="flex justify-center sm:justify-start items-center mt-1 space-x-3">
            <a
              href="/"
              className="text-gray-500 transition-colors duration-300 hover:text-orange-400"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 pt-1">
            ...
            <a
              ...
              className="text-gray-500 transition-colors duration-300 hover:text-orange-400"
            >
              <svg viewBox="0 0 30 30" fill="currentColor" className="h-6 pt-1">
            ...
            <a
              ...
              className="text-gray-500 transition-colors duration-300 hover:text-orange-400"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 pt-1">
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-gray-800 lg:flex-row">
        ...
        <ul className="flex flex-col text-center lg:text-left mb-3 lg:mb-0 sm:flex-row">
          <li>
            <a
              href="/"
              className="text-sm text-gray-500 transition-colors duration-300 hover:text-orange-400"
            >
              F.A.Q
            </a>
          </li>
          <li className="mt-2 sm:mt-0 sm:ml-5">
            <a
              href="/"
              className="text-sm text-gray-500 transition-colors duration-300 hover:text-orange-400"
            >
